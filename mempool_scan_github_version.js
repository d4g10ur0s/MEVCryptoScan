  ...
  customWsProvider.on("pending", (tx) => {
    ...
    customWsProvider.getTransaction(tx).then(async function (transaction) {//pairnw info transaction vasei hash
      try{//den se endiaferei ti einai
          if ((transaction != null && ethers.utils.getAddress(transaction.from).indexOf(address)!==-1)||
          (transaction != null && ethers.utils.getAddress(transaction.to).indexOf(address)!==-1)) {
            var end = Date.now();
            ...
            if(decodedData.functionFragment.name == 'swapExactETHForTokens' || decodedData.functionFragment.name == 'swapExactTokensForTokens'){
              ...
              console.log((parseInt(decodedData.value._hex)* Math.pow(10,-18)));
              try{
                await univ2_pair(decodedData.args[1][0]);
              }catch(e){
                console.log(e.message);
              }
              try{
                await univ2_pair(decodedData.args[1][1]);
              }catch(e){
                console.log(e.message);
              }
            }else{
              ...
              console.log("amountIn: ");
              console.log((parseInt(decodedData.args.amountIn._hex)* Math.pow(10,-18)));
              await univ2_pair(decodedData.args[2][0]);
              await univ2_pair(decodedData.args[2][1]);
            }
          }
